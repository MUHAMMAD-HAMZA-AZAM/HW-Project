...
namespace HW.LoggingApi.DbLogProvider
{
    public class SqlHelper
    {
        ...
        public bool InsertInformationLog(EventLog log)
        {
            string command = $@"INSERT INTO [dbo].[InformationLogs] ([EventID],[LogLevel],[Message],[CreatedTime]) VALUES (@EventID, @LogLevel, @Message, @CreatedTime)";
        ...
        public bool InsertErrorLog(EventLog log)
        {
            string command = $@"INSERT INTO [dbo].[ErrorLogs] ([EventID],[LogLevel],[Message],[CreatedTime]) VALUES (@EventID, @LogLevel, @Message, @CreatedTime)";
            List<SqlParameter> paramList = new List<SqlParameter>();
            paramList.Add(new SqlParameter("EventID", log.EventId));
            paramList.Add(new SqlParameter("LogLevel", log.LogLevel));
            paramList.Add(new SqlParameter("Message", log.Message));
