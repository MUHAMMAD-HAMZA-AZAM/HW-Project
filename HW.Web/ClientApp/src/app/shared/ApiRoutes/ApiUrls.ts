export var ApiUrls = {
  ...
  User: {
    ...
    GetFinishedJobDetail: "User/Job/GetFinishedJobDetail",
    InProgreesJobDetails: "User/InProgressJob/InProgreesJobDetails",
    TradesmanProfile: "User/Profile/TradesmanProfile",
    ReceivedBidDetail: "User/Job/ReceivedBidDetail",
    InProgressJobList: "User/InProgressJob/InProgressJobList",
    GetPostedJobs: "User/Quote/GetPostedJobs",
    PersonalProfile: "User/Profile/PersonalProfile",
    ReceivedBids: "User/Bids/ReceivedBids",
    GetPostedJobDetail:"User/Quote/GetPostedJobDetail",
    Home: {
  ...
  //Trademan: {
  //  TradesmanProfile:"Trademan/Profile/TradesmanProfile",
  //}
