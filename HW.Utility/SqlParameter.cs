    ...
    public static class SqlParameterExtensions
    {
        ...
        public static List<SqlParameter> ToSqlParamsList(this object obj, SqlParameter[] additionalParams = null)
        {
            var props = (
                ...
                let nameAttr = p.GetCustomAttributes(typeof(ParamNameAttribute), true)
                let ignoreAttr = p.GetCustomAttributes(typeof(IgnoreParamAttribute), true)
            ...
            props.ForEach(p =>
            {
                ...
                var name = p.Names.FirstOrDefault() as ParamNameAttribute;
