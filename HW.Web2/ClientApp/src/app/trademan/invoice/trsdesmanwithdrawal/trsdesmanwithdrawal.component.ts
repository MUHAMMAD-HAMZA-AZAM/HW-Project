...
@Component({
  selector: 'app-trsdesmanwithdrawal',
  templateUrl: './trsdesmanwithdrawal.component.html',
  styleUrls: ['./trsdesmanwithdrawal.component.css']
})
export class TrsdesmanwithdrawalComponent implements OnInit {
  ...
  public getWalletAmount() {
    ...
    this.common.GetData(this.common.apiRoutes.PackagesAndPayments.GetLedgerTransaction, true).then(result => {
