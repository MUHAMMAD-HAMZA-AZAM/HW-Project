...
export class PostedJobComponent implements OnInit {
  ...
  populatePostedJobsReport() {
    ...
    this.Loader.show();
    this.service.get(this.service.apiRoutes.Users.getPostedJobsWithDateLastDay + "?startDate=" + this.startDate + "&endDate=" + this.endDate).subscribe(result => {
