...
export class MenuItemComponent implements OnInit {
  ...
  public modelText: string = "Add New Menu Item";
  ...
  ngOnInit() {
    this.userRole = JSON.parse(localStorage.getItem("Menu"));
  ...
  public accountForm() {
    this.appValForm = this.fb.group({
      menuId: [0],
      menuItemName: ['', [Validators.required, Validators.maxLength(150)]],
      active: [false],
      iconName: ['', [Validators.required, Validators.maxLength(50)]],
    })
  }
  ...
  public postData(data) {
    ...
    this.Loader.show();
    this.service.PostData(this.service.apiRoutes.Users.AddUpdateMenuItem, data, true).then(res => {
  ...
  resetForm(): void {
    ...
    this.appValForm.controls['menuId'].setValue(0);
  }
