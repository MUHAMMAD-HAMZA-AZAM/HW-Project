...
@Component({
  selector: 'app-supplier-hw',
  templateUrl: './app-supplier-hw.component.html',
  styleUrls: ['./app-supplier-hw.component.css']
})
export class AppSupplierHWComponent implements OnInit {
  ...
  @ViewChild('supplierLiveModalConfirm') supplierLiveModalConfirm: TemplateRef<any>;
  ...
  ngOnInit() {
    ...
    this.userRole = JSON.parse(localStorage.getItem("HoomWork Supplier List"));
  ...
  populateSupplierList() {
    ...
    this.service.post(this.service.apiRoutes.Users.SpGetHoomWorkSupplierList, obj).subscribe(result => {
      if (result.json() != null) {
  ...
  public BussinessProfile(supplierId: number, ref: any) {
    ...
    let obj = {
      ...
      supplierRole: SupplierRole.hoomworkSupplier
    };
    console.log(obj);
