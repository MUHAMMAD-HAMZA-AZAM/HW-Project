...
@Component({
  selector: 'app-trades-man-by-category',
  templateUrl: './trades-man-by-category.component.html',
  styleUrls: ['./trades-man-by-category.component.css']
})
export class TradesManByCategoryComponent implements OnInit {
  ...
  @ViewChild('gujratChartContainer') gujratChartContainer: ElementRef;
  @ViewChild('lahoreChartContainer') lahoreChartContainer: ElementRef;
  @ViewChild('islamabadChartContainer') islamabadChartContainer: ElementRef;
  @ViewChild('karachiChartContainer') karachiChartContainer: ElementRef;
  @ViewChild('gujranwalChartContainer') gujranwalChartContainer: ElementRef;
  constructor(public service: CommonService, public toastr: ToastrService, public Loader: NgxSpinnerService) {
    //let obj = 
    //this.selectedCities.push(obj);
    ...
    this.service.PostData(this.service.apiRoutes.TrdesMan.TradesmanByCategory, obj, true).then(result => {
      ...
      if (this.tradesmanList != null && this.tradesmanList.length > 0) {
        ...
        if (cid == "" || cid == null) {
          ...
          this.gujratPieChart.title.text = "Gujrat Tradesman";
          ...
          this.gujranwalaPieChart.title.text = "Gujranwala Tradesman";
          ...
          this.lslamabadPieChart.title.text = "Islamabad Tradesman";
