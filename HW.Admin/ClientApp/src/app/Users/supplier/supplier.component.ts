...
export class SupplierComponent implements OnInit {
  ...
  ngOnInit() {
    this.userRole = JSON.parse(localStorage.getItem("Supplier"));
  ...
  populateSupplierList() {
    ...
    this.service.post(this.service.apiRoutes.Users.SpGetSupplierList, obj).subscribe(result => {
      if (result.json() != null) {
  ...
  GetBussinessProfile(supplierId) {
    
    this.service.get(this.service.apiRoutes.Users.getBussinessProfile + "?userId=" + supplierId + "&role=" + 'Supplier').subscribe(result => {
