...
export class BookNowComponent implements OnInit {
  ...
  public urgentJobsList: any = [];


  jwtHelperService: JwtHelperService = new JwtHelperService();

  constructor(public _modalService: NgbModal, public fb: FormBuilder, public toastr: ToastrService, public service: CommonService, public Loader: NgxSpinnerService,) { }

  ngOnInit() {
    //this.accountTypeForm();
    this.getUrgentJobsList();
  ...
  getUrgentJobsList() {
    this.Loader.show();
    this.service.get(this.service.apiRoutes.Jobs.GetUrgentJobsList).subscribe(res => {
      this.urgentJobsList = res.json();
      this.Loader.hide();
    })
  }
  saveAndUpdate() {
